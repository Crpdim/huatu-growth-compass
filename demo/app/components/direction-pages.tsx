        ...
        {sampleDirection === "public" ? (
          <div className="rolemodel-layout">
            ...
            <article className="rolemodel-detail">
              ...
              <div className="rolemodel-actions"><button className="ghost-button route-question-button" onClick={() => onSetRouteChatOpen(true)}>✦ 问问这条路</button><button className="primary-button" onClick={onEnterManagement}>完成方向探索，进入职途有声 <span>→</span></button></div>
            </article>
          </div>
        ) : (
      ...
      <section className="content-page futures-page">
        ...
        <div className="future-decision-grid">
          <article className="future-featured">
            ...
            <footer><p><b>你想解决：</b>{purposeTitle}</p><button className="primary-button" onClick={onEnterManagement}>完成方向探索，进入职途有声 <span>→</span></button></footer>
          </article>
