...
export function ManagementActionPages(props: ManagementActionPagesProps) {
  ...
  if (stage === "importing") {
    return <section className="content-page profile-import-page"><article className="profile-import-card" aria-live="polite">
      <div className="app-transfer-visual" aria-label="正在将方向探索结果导入职图有声任务空间"><div className="app-transfer-source"><span>罗</span><small>职图有声 · 方向探索</small><b>方向探索已完成</b></div><div className="app-transfer-route"><i /><span>正在导入</span><b>→</b></div><div className="app-transfer-target"><span>管</span><small>职图有声 · 任务伴学</small><b>任务与伴学空间</b></div></div>
      <span className="section-kicker">正在切换应用</span><h2>正在导入用户画像</h2><p>方向探索已经完成，现在把已确认画像、授权范围和方向线索导入任务与伴学空间。</p>
