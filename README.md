...
> “你迷茫吗？” → 人生课题选择 → 情境探索 → 可修正的初始画像 → 用户授权补充事实 → 三种平行人生 → 体制内未来生活体验 → “我该怎么实现” → 7 天考公验证计划

产品逻辑仍支持考研、公考/考编和企业求职三条路径；比赛 Demo 只将体制内人生分支做完整，其他两条用于证明入口不是单线导流。首版不追求功能数量，只证明推荐有依据、未来可体验、体验会产生新证据、下一步任务可执行，且 AI 失败时仍可演示。
